                    ...
                    <el-tabs tab-position="top"  @tab-click="clickTab" v-model="rightActive" >
                        <el-tab-pane name="详细信息" label="详细信息">
                            <div class="information" >
                                <el-image v-show="item.type === '2'&&!showRecycleMsg" :src="config.resPre+item.path+'?width=100&height=100'" fit="contain" style="width: 270px;height: 140px;background: #ccc;margin-top: 15px"></el-image>
                            ...
                            <div v-show="showRecycleMsg" style="position: absolute;bottom: 60px;margin-left: 10px">
        ...
        closeNodes(nodes){
            if(null !== nodes){
                ...
                for(var i=0;i<nodes.length;i++){
                    this.closeNodes(nodes[i].childNodes)
